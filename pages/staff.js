...
export default class staff extends Component {
    ...
    ListViewItemSeparator = () => {
        ...
        img = (SPhoto) => {
          switch (SPhoto) {
            case '7501.jpg':
              return (<Image style={styles.pic}a source={require('../images/staff/7501.jpg')} style={{padding: 10,borderRadius: 30,
                width: 60,
                height: 60,}} /> );
                case '7503.jpg':
              return (<Image style={styles.pic} source={require('../images/staff/7503.jpg')} style={{padding: 10,borderRadius: 30,
                width: 60,
                height: 60,}} />);
                case '7504.jpg':
              return (<Image style={styles.pic} source={require('../images/staff/7504.jpg')} style={{padding: 10,borderRadius: 30,
                width: 60,
                height: 60,}} />);
                case '7502.jpg':
                  return (<Image style={styles.pic} source={require('../images/staff/7502.jpg')} style={{padding: 10,borderRadius: 30,
                    width: 60,
                    height: 60,}} />);
          }
        };
